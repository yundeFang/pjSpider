...
#关键词
keyWords = ['培训', '产教', '产学', '双师', '实训', '真账', '投标', '竞标', '技能', '就业', '会计技能', '金融会计', '管理会计', '合作', '联盟', '学校', '学院', '高职', '中职', '机构', '平台', '协会']
...
try:
    ...
    print("shandongshuilizhiye dead")
# 山东水利职业学院 end
...
try:
    ...
    print("shandonglaodongzhiye dead")
# 山东劳动职业 end
...
try:
    ...
    print("yantaiqichegongcheng dead")
# 烟台汽车工程 end.
...
try:
    ...
    print("jngongchengzhiyejishu dead")
# 山东工程职业技术学院 end
...
try:
    ...
    print("weifanggongshangzhiye dead")
# 潍坊工商职业 end
...
try:
    ...
    print("yantaigongchengzhiye dead")
# 烟台工程职业技术学院 end.
